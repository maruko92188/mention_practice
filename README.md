...
3. `#{自分のアカウント名}/fjord-books_app-2025` が作成されます。
4. 作業PCの任意の作業ディレクトリにて `git clone` してください。

```
$ git clone https://github.com/自分のアカウント名/fjord-books_app-2025.git
```

4. `cd fjord-books_app-2025` でカレントディレクトリを変更してください。
